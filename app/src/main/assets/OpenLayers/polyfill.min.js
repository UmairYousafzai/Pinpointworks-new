  ...
  !(function (e) {
    ...
    !(function () {
      ...
      function u(e, t) {
        var n = 0;
        this.next = function () {
          if (n >= e.length) return { done: !0, value: void 0 };
          var r = e[n++];
          return {
            done: !1,
            value:
            ...
            if (
              ...
              document.implementation.createHTMLDocument
                ...
                : window.ActiveXObject &&
                  ...
                  e.write("<head></head><body></body>"),
                  e.close()),
              !e)
            )
              throw Error("base not supported");
            var r = e.createElement("base");
            (r.href = n), e.getElementsByTagName("head")[0].appendChild(r);
      ...
      try {
        if (s) {
          if (((c = new e.URL("http://example.com")), "searchParams" in c))
            return;
          "href" in c || (c = void 0);
        }
      } catch (f) {}
      if (
        ...
        for (var h in s)
          s.hasOwnProperty(h) && "function" == typeof s[h] && (l[h] = s[h]);
